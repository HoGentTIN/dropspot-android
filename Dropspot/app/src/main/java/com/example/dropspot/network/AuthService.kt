...
interface AuthService {
    ...
    fun register(@Body signUpRequest: RegisterRequest): Call<MessageResponse>

    @POST("auth/signup/mod")
    fun registerMod(@Body signUpRequest: RegisterRequest): Call<MessageResponse>

    @POST("auth/signup/admin")
    fun registerAdmin(@Body signUpRequest: RegisterRequest): Call<MessageResponse>
